...
public class BlockUserPanelAuthority extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_block_user_panel_authority);
    ...
    private void viewNotice(String str) {
        ...
        mquery = mDatabaseValidContent.orderByChild("DEST").equalTo("HOD");
        ...
        //   mProgress.show();
        FirebaseRecyclerAdapter<BlogModel, com.rcoem.enotice.enotice_app.HighAuthorityClasses.BlockUserPanelAuthority.BlogViewHolder> firebaseRecyclerAdapter = new
                FirebaseRecyclerAdapter<BlogModel, com.rcoem.enotice.enotice_app.HighAuthorityClasses.BlockUserPanelAuthority.BlogViewHolder>(

                        BlogModel.class,
                        R.layout.block_view,
                        com.rcoem.enotice.enotice_app.HighAuthorityClasses.BlockUserPanelAuthority.BlogViewHolder.class,
                        mquery
                ) {
                    @Override
                    protected void populateViewHolder(com.rcoem.enotice.enotice_app.HighAuthorityClasses.BlockUserPanelAuthority.BlogViewHolder viewHolder, BlogModel model, int position) {
                        ...
                        viewHolder.mView1.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(BlockUserPanelAuthority.this);
                                ...
                                mDatabase.addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        ...
                                        Glide.with(BlockUserPanelAuthority.this).load(url).diskCacheStrategy(DiskCacheStrategy.ALL).into(circularImageView);
                                    }
                                            ...
                                            mDatabase.addValueEventListener(new ValueEventListener() {
                                                ...
                                                public void onDataChange(DataSnapshot dataSnapshot) {
                                                    if (process) {
                                                        ...
                                                        process = false;
                                                        Toasty.custom(BlockUserPanelAuthority.this, "User Has been Unblocked", R.drawable.ok, getResources().getColor(R.color.colorWhite), getResources().getColor(R.color.unblocked), 100, true, true).show();
                                            ...
                                            mDatabase.addValueEventListener(new ValueEventListener() {
                                                ...
                                                public void onDataChange(DataSnapshot dataSnapshot) {
                                                    if (process) {
                                                        ...
                                                        mSwitch.setChecked(true);
                                                        process = false;
                                                        Toasty.custom(BlockUserPanelAuthority.this, "User Has been Blocked", R.drawable.cancel, getResources().getColor(R.color.colorWhite), getResources().getColor(R.color.blocked), 100, true, true).show();
    ...
    public static class BlogViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setImage(Context context, String image) {
            ...
            ImageView post_image = (ImageView) mView1.findViewById(R.id.prof_pic_block_view);
        ...
        public void setName(String name) {
            ...
            TextView post_Desc = (TextView) mView1.findViewById(R.id.name_block_view);
        ...
        public void setDesg(String Desg) {
            ...
            TextView post_Desc = (TextView) mView1.findViewById(R.id.designation_block_view);
            if (Desg.equals("AP")) {
        ...
        public void setBlockStatus(String status) {
            ...
            LinearLayout li_status = (LinearLayout) mView1.findViewById(R.id.li_block_status);
